export const storefrontData = {
  ...
  description:
    'Neelabh Hues of Blues - A unique shop offering a wide range of artistic and creative products. Explore our collection and find something special for yourself.',
  contact: {
